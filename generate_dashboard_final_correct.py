#!/usr/bin/env python3
"""
Gerar dashboard final com quartis corrigidos usando Video Starts
"""
...
def generate_dashboard_final_correct():
    """Gerar dashboard final com quartis corrigidos"""
    ...
    # Carregar dados corrigidos dos quartis (Video Starts)
    ...
    # Substituir variáveis dos quartis corrigidos (Video Starts)
    for key, value in quartis_data.items():
        template_content = template_content.replace(f"{{{{{key}}}}}", value)
    
    # Gerar nome do arquivo
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    filename = f"static/dash_semana_do_pescado_FINAL_CORRECT_{timestamp}.html"
    
    # Salvar dashboard
    with open(filename, 'w', encoding='utf-8') as f:
        f.write(template_content)
    
    print("✅ DASHBOARD FINAL CORRETO GERADO!")
    print("=" * 70)
    ...
    print("✅ Quartis: Percentuais baseados em Video Starts (702.670)")
    print("✅ 25%: 641.925 (91,36% dos Video Starts)")
    print("✅ 50%: 536.869 (76,40% dos Video Starts)")
    print("✅ 75%: 418.194 (59,51% dos Video Starts)")
    print("✅ 100%: 394.819 (56,19% dos Video Starts)")
    print("✅ Formatação: PT-BR (ponto para milhares, vírgula para decimais)")
    print("✅ Lógica: Video Starts = universo total de dados")
