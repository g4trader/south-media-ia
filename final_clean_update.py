#!/usr/bin/env python3
"""
Script final limpo para atualizar ambas as abas
"""
...
def final_clean_update():
    """Atualização final limpa"""
    ...
    # Dados de setembro (Footfall Set) - da planilha gid=1814755757
    footfall_set_data = [
        {
    ...
    # Dados de outubro (Footfall Out) - da planilha gid=120680471
    footfall_out_data = [
        {
...
if __name__ == "__main__":
    ...
    if final_clean_update():
        print("\n🎉 Atualização final concluída!")
        print("📋 Resultado:")
