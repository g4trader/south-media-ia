#!/usr/bin/env python3
"""
Gerar dashboard final com dados corrigidos (quartis e totais)
"""
...
def generate_dashboard_final_corrected():
    ...
    filename = f"static/dash_semana_do_pescado_FINAL_CORRECTED_{timestamp}.html"
    ...
    print()
    print("📊 MÉTRICAS DE QUARTIS DE VÍDEO (YouTube + Programática):")
    ...
    print()
    print("📊 ESTRATÉGIAS (DADOS CORRIGIDOS):")
    ...
    print("✅ Quartis: Agora mostram YouTube + Programática")
    print("✅ 25% Total: 641.925 (162,59%)")
    print("✅ 50% Total: 536.869 (135,98%)")
    print("✅ 75% Total: 418.194 (105,92%)")
    print("✅ 100% Total: 394.819 (100,00%)")
    
    return filename

if __name__ == "__main__":
    generate_dashboard_final_corrected()